/*
Linked list sample program from lab 3 on brightspace. The main.c function has been stripped out and the subroutines
have been linked to the new main.c for use in driving the project. Dequeue function has been modified to have the tail
equal NULL if the list is emptied when dequeing to avoid a bug where the linked list got dereferenced
*/
